...
namespace tq.NET {
    class Program {
        static void Main(string[] args) {
            ...
            ArgParser.add_option("featured||f||F", ArgParser.option_type.FLAG);
            ArgParser.add_option("topgames||t||T", ArgParser.option_type.FLAG);
            ArgParser.add_option("search||s", ArgParser.option_type.OPTION);
            ArgParser.add_option("debug||D", ArgParser.option_type.FLAG);
            ArgParser.add_option("print||p||P", ArgParser.option_type.OPTION);
            ArgParser.add_option("limit||l", ArgParser.option_type.OPTION);
